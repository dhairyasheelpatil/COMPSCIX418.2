// Worked on with Soham
// You can see more of the git history here https://github.com/zacbennett/amazon-mock-assignment
...
public class User {
    ...
    public List<Item> listItems() {
        this.handleUserInteraction();
        return this.cart.getInstance().listItems();
    }
}

// observer pattern where session is the producer, user is the subscriber
